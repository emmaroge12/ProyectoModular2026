"""
Django settings for CBVdemo project.
...
SECRET_KEY = 'django-insecure-pelg+d%x2emjmp_i^o6rv61bt1ju6#4@4a#2#sf*hre@zy@zkp'
...
WSGI_APPLICATION = 'CBVdemo.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '515Tema5#',            # Contraseña de MySQL
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / "static"]   # Archivos estáticos globales
STATIC_ROOT = BASE_DIR / "staticfiles"     # Carpeta donde se recopilan en producción
